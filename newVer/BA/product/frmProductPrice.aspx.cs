...
public partial class CRM_product_frmCrmCustomerFixPrice : System.Web.UI.Page
{
    ...
    /*
        ...
        */
        ...
        script.Append("var specifications=\"" + this.Request.QueryString["Specifications"] + "\";");
        script.Append("var specificationsText=\"" + this.Request.QueryString["SpecificationsText"] + "\";");
    ...
    protected void Page_Load( object sender, EventArgs e )
    {
        ...
        switch ( method )
        {
            ...
            case "getCustomers":
                ...
                break;
            case "getWhPrice":
                ZJSIG.UIProcess.CRM.UICrmCustomerFixpice.getWhPrice( this );
                break;
            default:
                return;
        }
