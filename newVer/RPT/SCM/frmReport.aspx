...
<head runat="server">
    ...
    <%--<script type="text/javascript" src="../../js/Ext.mulSelect.js"></script>--%>
    <style media=print>
...
//    var dsWareHouse = new Ext.data.SimpleStore({
//fields:['WhId','WhName'],
//data:[['83','临平仓库'],['84','塘栖仓库'],['86','余杭仓库'],['85','瓶窑仓库'],['101000','市场营销部仓库'],['101160','门市部仓库'],['101440','塘栖2号仓库']],
//autoLoad: false});
    //设置mulSelectComboBox
//    var mulSelect=new ZJSIG.UI.MultiSelect(
//    {fieldLabel: '配送人',
////    renderTo:'mulSelect',
//                        anchor: '95%',
//                        id: 'DriverId',
...
<body style="margin: 0px; padding: 0px; border-top-style: 0; border-right-style: 0; border-bottom-style: 0; border-left-style: 0; border-width: 0px; border-top-color: 0; border-right-color: 0; border-bottom-color: 0; border-left-color: 0">
    ...
    <tr>
    <td>
    <asp:Label Text="统计仓库" ID="lblStore" runat="server" Font-Size="Small"></asp:Label>
            <asp:DropDownList ID="ddlStore" onselectedindexchanged="bindUnitEvent" AutoPostBack="true" runat="server" ></asp:DropDownList>
            <asp:Label Text="统计部门" ID="lblDept" runat="server" Font-Size="Small" Visible=false></asp:Label>
            <asp:DropDownList ID="ddlDept" AutoPostBack="false" runat="server" Visible="false" ></asp:DropDownList>
            <asp:Label Text="统计单位" ID="lblUnit" runat="server" Font-Size="Small"></asp:Label>
    ...
    <asp:HiddenField ID='hiddenProduct' runat="server" />
       <asp:Label ID="Label1" Text="产品不分产地" runat="server" Font-Size="Small"> </asp:Label><asp:CheckBox ID="chbClass" runat="server" />
    <asp:Label ID="Label2" Text="报表类别" runat="server" Font-Size="Small"> </asp:Label><asp:TextBox ID="txtReportType" Text="" runat="server" onclick="showReportTypeFrom();"></asp:TextBox>
    <asp:HiddenField ID='hiddenReportType' runat="server" />
    <asp:Label ID="lblRoute" Text="客户线路" runat="server" Visible="false" Font-Size="Small"> </asp:Label><asp:TextBox ID="txtRouteName" Visible="false" Text="" runat="server" onclick="showRouteTreeForm();"></asp:TextBox>
    <asp:HiddenField ID='hiddenRoute' runat="server" />
    <asp:Label ID="lblWh" Text="仓库" Visible="false" runat="server" ></asp:Label><asp:TextBox ID="txtWh" Visible="false"  Text="" runat="server" onclick="showWhTreeForm();"></asp:TextBox>
    <div id="mulSelect"></div>
    <asp:HiddenField ID="hiddenWh" runat="server" />
    <asp:Label ID="lblSaleUnit" Text="销售单位" Visible="false" runat="server" Font-Size="Small"></asp:Label><asp:CheckBox ID="chbSaleUnit" Checked="true" Visible="false" runat="server" />
    </asp:Panel>
    </td>
    </tr>
    </table>
