<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmQuotaItemSelect.aspx.cs" Inherits="ZJ_frmQuotaItemSelect" %>
...
Ext.onReady(function() {
   var Toolbar = new Ext.Toolbar({
    ...
    function saveQuotas()
    {
        var sm = quotaGrid.getSelectionModel();
            ...
            Ext.Ajax.request({
                url: 'frmQuotaItemSelect.aspx?method=saveQuota',
                method: 'POST',
                params: {
                    TemplateNo: pkId,
                    QtReportQuotaNo:pkId,
                    QuotaType:quotaType,
                    QuotaNo: ids
                },
   ...
   quotaListStore = new Ext.data.Store
	({
	    url: 'frmQuotaItemSelect.aspx?method=getlist',
...
function loadData() {
        ...
        {
            case"template":
                quotaListStore.baseParams.TemplateNo = pkId;
                break;
            default:
