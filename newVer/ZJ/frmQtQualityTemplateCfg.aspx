	 ...
	 <div id="quotaTemplate_grid"></div>
        ...
        function addTypeProduct(templateNo) {
            if (addQuotasWin == null) {
                addQuotasWin = ExtJsShowWin('添加标准指标信息', 'frmQuotaItemSelect.aspx?TemplateNo=1&pkId=' + templateNo, 'add', 800, 500);
                addQuotasWin.show();
            }
            else {
                addQuotasWin.show();
                           ...
                           items: [
                           {
                               ...
                               items: [{
                                   ...
                                   items: [ {
                                       ...
                                       cls: 'key',
                                       xtype: 'textfield',
                                       fieldLabel: "执行标准<font color='red'>*</font>",
                                           ...
                                           var sm = new Ext.grid.CheckboxSelectionModel(
            {
                singleSelect: false
                        ...
                        new Ext.grid.RowNumberer(), //自动行号
									        ...
									        { header: '标准名称', dataIndex: 'TemplateName' },
											{ header: '执行标准', dataIndex: 'TemplateStandard' }, 
											{ header: '对应盐种', dataIndex: 'Note' }, 
...
var templateQuotaForm = new Ext.Panel(   
 { 
   ...
   width:'100%',
   layout:'table',            
   layoutConfig:{columns:5},//将父容器分成3列
   items:[
 ...
 if (typeof (quotaTemplateQuotasWindow) == "undefined") {//解决创建2个windows问题
...
var templateSaltForm = new Ext.Panel(   
 ...
 if (typeof (quotaTemplateSaltWindow ) == "undefined") {//解决创建2个windows问题
