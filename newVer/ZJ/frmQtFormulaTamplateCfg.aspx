	                                ...
	                                var detailsm = new Ext.grid.CheckboxSelectionModel(
            {
                singleSelect: false
                        ...
                        new Ext.grid.RowNumberer(), //自动行号
                                            {header: '指标号', dataIndex: 'FormulaNo',width:50 },
                                            { header: '指标号', hidden: true, dataIndex: 'QuotaNo' },
                                            //{ header: '所属公司', dataIndex: 'OrgName' },
									        { header: '指标名称', dataIndex: 'QuotaName',width:130 },
									        { header: '公式', dataIndex: 'QuotaFormula',width:180 },
									        { header: '单位', dataIndex: 'QuotaUnit',width:50 }
			  ]), listeners:
			  {
