<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmQtCGNotify.aspx.cs" Inherits="ZJ_frmQtCgzjTzd" %>
               ...
               var Toolbar = new Ext.Toolbar({
                   ...
                   items: [{
                       ...
                       handler: function() {
                           ...
                           top.createDiv(record.ProductName+"质检","/ZJ/frmQtCheckInput.aspx?FromBillType=Q1401&FromBillId="+modify_quota_id);
//                           formulaWindow.show();
//                           setformvalue(record);
...
//                       }
 ...
 function setAuthorize()
 {
    ...
    {                
        document.getElementById("editIFrame").src = "frmSampleAuthorizeInput.aspx?FromBillType=Q1401&FromBillId=" +modify_quota_id;
    }
    else{
        document.getElementById("editIFrame").contentWindow.AuthorizeId=-1;
        document.getElementById("editIFrame").contentWindow.fromBillId=modify_quota_id;
        document.getElementById("editIFrame").contentWindow.fromBillType='Q1401';
...
//                       anchor: '90%'
        ...
        },
        {
           ...
           items: [
		   {
			...
			({
			    url: 'frmQtQualityCheckNotify.aspx?method=getCNList&zjtype=Q091',
                               ...
                               var sm = new Ext.grid.CheckboxSelectionModel(
            {
               ...
               var quotaGrid = new Ext.grid.GridPanel({
                   ...
                   cm: new Ext.grid.ColumnModel([
						...
						{ header: '质检状态', dataIndex: 'CheckStatusName',width:100}
