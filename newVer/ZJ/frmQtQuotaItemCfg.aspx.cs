    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        { 
            ...
            case "getOrgs":
                ...
                break;
            case "getTemplate":
                ZJSIG.UIProcess.QT.UIQtQualityTemplateCfg.getAllTemplateCfg( this );
                break;
            case"getQuotaTemplate":
                ZJSIG.UIProcess.QT.UIQtQuotaTemplateRel.getRelsByQuotal( this );
                break;
            case"saveQuotaTemplate":
                ZJSIG.UIProcess.QT.UIQtQuotaTemplateRel.saveQuotaTemplate( this );
                break;
        }
