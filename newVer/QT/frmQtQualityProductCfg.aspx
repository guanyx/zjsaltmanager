<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmQtQualityProductCfg.aspx.cs" Inherits="QT_QtQualityProductCfg" %>
           ...
           Ext.onReady(function() {
               ...
               renderTo: "product_toolbar",
                   ...
                   function delQuota(rownum) {
                       ...
                       if (rownum == 1) {
                           ids = recorddel[0].data.ConfigNo;
                       } else {
                           for (var i = 0; i < rownum; i++) {
                               ids += recorddel[i].data.ConfigNo + ',';
                           }
                           ids = ids.substring(0, ids.length - 1);
                       }

                       Ext.Ajax.request({
                           url: 'frmQtQualityProductCfg.aspx?method=delPro'
                               , params: {
                                   ids: ids
                               },
                           //成功时回调 
                   ...
                   if (typeof (formulaWindow) == "undefined") {//解决创建2个windows问题
                       ...
                       function openthewin() {
                           ...
                           var dsSmallProduct = new Ext.data.Store({
                               url: 'frmQtQualityProductCfg.aspx?method=getSmallClasses',
                        ...
                        { name: 'Specifications', mapping: 'Specifications' }
                           ...
                           var searchSmallClass = new Ext.form.ComboBox({
                               ...
                               onSelect: function(record) { // override default onSelect to do redirect  
                                   ...
                                   Ext.getCmp('ProductClassid').setValue(record.data.ProductId);
                                   Ext.getCmp('standar').setValue(record.data.Specifications);
                                   placeComb.setValue(record.data.Origin);
                                   this.collapse();
                               }
                           });
...
,
                   ...
                   var yqComb = new Ext.form.ComboBox({
                       ...
                       store: new Ext.data.Store({
                           ...
                           proxy: new Ext.data.HttpProxy({
                           url: 'frmQtOtherOptionCfg.aspx?method=queryByCode&code=Q044'
                           }),
                           // create reader that reads the project records
                           reader: new Ext.data.JsonReader({ root: 'root' }, [
                                { name: 'name', type: 'string' },
                   ...
                   var soltComb = new Ext.form.ComboBox({
                       ...
                       store: new Ext.data.Store({
                           ...
                           proxy: new Ext.data.HttpProxy({
                               url: 'frmQtQualityProductCfg.aspx?method=getallSolt'
                           }),
                           // create reader that reads the project records
                           reader: new Ext.data.JsonReader({ root: 'root' }, [
                   ...
                   function addFormula() {
                       ...
                       var qurl = 'frmQtQualityProductCfg.aspx?method=addProd';
                       if (modify_quota_id != '' && modify_quota_id != null && addmark == 0) {
                           qurl = 'frmQtQualityProductCfg.aspx?method=updatePro&configno=' + modify_quota_id;
                       }
                       Ext.Ajax.request({
                           url: qurl
                               , params: {
                   ...
                   function modifyQuota(rownum) {
                       ...
                       Ext.getCmp("ProductClassid").setValue(record.ProductClassid);
...
//	                                           triggerAction:'all'
		...
		,
		{
			...
			({
			    url: 'frmQtQualityProductCfg.aspx?method=queryProduct',
			    reader: new Ext.data.JsonReader({
			        totalProperty: 'totalProperty',
			        root: 'root'
			    }, [
