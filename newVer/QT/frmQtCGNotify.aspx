<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmQtCGNotify.aspx.cs" Inherits="QT_frmQtCgzjTzd" %>
                               ...
                               var sm = new Ext.grid.CheckboxSelectionModel(
            {
                singleSelect: false
                        ...
                        new Ext.grid.RowNumberer(), //自动行号
                                            ...
                                            { header: '质检类型', dataIndex: 'DicsName' },
									        { header: '货单编号', dataIndex: 'DeliveryNo' },
									        { header: '车船号', dataIndex: 'ShipNo' },
											{ header: '供应商名称', dataIndex: 'ProviderName' },
											...
											{ header: '是否质检完成', dataIndex: 'CheckStatus', renderer: cktp }
