<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDayReportUp.aspx.cs" Inherits="Common_frmDayReportUp" %>
...
Ext.onReady(function() {
    ...
    function saveRecord()
    {
        ...
        var xml = encodeURIComponent(JsonToXml(gridStore,colModel));
         Ext.Ajax.request({
                    url: 'frmDayReportUp.aspx?method=savecustomer',
                    method: 'POST',
                    params: {
                        formType:formType,
                        CreateDate:document.getElementById('itemDateFrom').value,
                        xml: xml
                    },
...
　　　　　　　　　　　}}],
        ...
        function PrintList() {
          ...
          printControl.GridData = JsonToXml(gridStore, viewGrid.colModel);
          printControl.GridStyle = ColMolToXml(viewGrid.colModel);
