<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmCommonListUpdate.aspx.cs" Inherits="Common_frmCommonListUpdate" %>
...
<head runat="server">
    ...
    {
        gridStore.baseParams.CustomerIds = customerIds;
        gridStore.load();
    }
...
Ext.onReady(function() {
    ...
    function saveRecord()
    {
        ...
        var xml = encodeURIComponent(JsonToXml(gridStore,colModel));
         Ext.Ajax.request({
                    url: 'frmCommonListUpdate.aspx?method=savecustomer',
                    method: 'POST',
                    params: {
                        formType:formType,
                        xml: xml
