<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmOtherLoadFee.aspx.cs" Inherits="RPT_WMS_frmOtherLoadFee" %>
...
var gridStore = new Ext.data.GroupingStore({
    url: 'frmSendLoadFee.aspx?method=getlist',
...
var reportView='v_rpt_other_load_fee';
</script>
<script type="text/javascript">
...
function saveUserData() {
    ...
    Ext.Msg.wait("保存中....","提示");
    Ext.Ajax.request({
        url:'frmOtherLoadFee.aspx?method=settleOtherLoadFee',
        method:'POST',
        params:{
