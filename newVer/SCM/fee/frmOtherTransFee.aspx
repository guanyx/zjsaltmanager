<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmOtherTransFee.aspx.cs" Inherits="RPT_WMS_frmOtherTransFee" %>
...
var gridStore = new Ext.data.GroupingStore({
    url: 'frmSendTransFee.aspx?method=getlist',
...
var reportView='v_rpt_other_trans_fee';
</script>
<script type="text/javascript">
...
function saveUserData() {
    ...
    Ext.Msg.wait("保存中....","提示");
    Ext.Ajax.request({
        url:'frmOtherTransFee.aspx?method=settleOtherTransFee',
        method:'POST',
        params:{
