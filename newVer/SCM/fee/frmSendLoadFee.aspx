<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSendLoadFee.aspx.cs" Inherits="RPT_WMS_frmSendLoadFee" %>
...
var reportView='v_rpt_send_load_fee';
</script>
<script type="text/javascript">
...
function saveUserData() {
    ...
    Ext.Msg.wait("保存中....","提示");
    Ext.Ajax.request({
        url:'frmSendLoadFee.aspx?method=settleFee',
        method:'POST',
        params:{
