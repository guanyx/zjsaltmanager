<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPurchaseTransFee.aspx.cs" Inherits="RPT_WMS_frmPurchaseTransFee" %>
...
var gridStore = new Ext.data.GroupingStore({
    url: 'frmPurchaseTransFee.aspx?method=getlist',
...
var reportView='v_rpt_purchase_trans_fee';
</script>
<script type="text/javascript">
...
function saveUserData() {
    var amt = Ext.getCmp('TransAmt').getValue();
    ...
    Ext.Msg.wait("保存中....","提示");
    Ext.Ajax.request({
        url:'frmPurchaseTransFee.aspx?method=settleFeeForTrans',
        method:'POST',
        params:{
            VoiceNumber:Ext.getCmp('VoiceNumber').getValue(),
            LoadAmt:Ext.getCmp('TransAmt').getValue(),
            ...
            OrderId:gridStore.baseParams.OrderId,
            Type:'purchase'
        },
