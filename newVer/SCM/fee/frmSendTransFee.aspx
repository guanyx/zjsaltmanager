<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSendTransFee.aspx.cs" Inherits="RPT_WMS_frmSendTransFee" %>
...
var reportView='v_rpt_send_trans_fee';
</script>
<script type="text/javascript">
...
function saveUserData() {
    ...
    Ext.Msg.wait("保存中....","提示");
    Ext.Ajax.request({
        url:'frmSendTransFee.aspx?method=settleFeeForTrans',
        method:'POST',
        params:{
