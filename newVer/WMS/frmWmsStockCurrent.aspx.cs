...
public partial class WMS_frmWmsStockCurrent : PageBase
{
    /// <summary>
    /// 得到界面需要的所有基础代码
    /// </summary>
        ...
        try
        {
            ...
            { 
                ...
                case "getWarehousePositionList":
                    ...
                    break;
                case "getProductList":
                    UIBaProduct.getProductList(this);
                    break;
                case "getCurrentStockList":
                    UIWmsStockCurrent.getCurrentStockList(this);
                    break;
                case "getgroupby":
                    ZJSIG.UIProcess.UIProcessBase.GetGroupStore(this, "VWmsStockCurrentCostList");
                    break;
                case"clearZeroProductStore":
                    UIWmsStockCurrent.clearZeroProductStore( this);
                    break;
            }
        }
