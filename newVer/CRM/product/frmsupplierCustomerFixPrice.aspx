<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmsupplierCustomerFixPrice.aspx.cs"
...
Ext.onReady(function() {
    ...
    if (dsCustomers == null) {
        dsCustomers = new Ext.data.Store({
            url: 'frmsupplierCustomerFixPrice.aspx?method=getCustomers',
    ...
    var Toolbar = new Ext.Toolbar({
        ...
        function openAddFixpiceWin() {
            ...
            if (dsProducts == null) {
                dsProducts = new Ext.data.Store({
                    url: 'frmsupplierCustomerFixPrice.aspx?method=getSppierProducts',
                    reader: new Ext.data.JsonReader({
                        root: 'root',
                        totalProperty: 'totalProperty'
                    }, [
            ...
            dsProducts.on('beforeload', function() {
                dsProducts.baseParams.SuppierId = Ext.getCmp("CustomerId").getValue();
            });
        ...
        function deleteFixpice() {
            ...
            Ext.Msg.confirm("提示信息", "是否真的要删除选择的信息吗？", function callBack(id) {
                ...
                if (id == "yes") {
                    //页面提交
                    Ext.Ajax.request({
                        url: 'frmsupplierCustomerFixPrice.aspx?method=deleteFixpice',
                        method: 'POST',
                        params: {
        ...
        function saveUserData() {
            ...
            Ext.Ajax.request({
                url: 'frmsupplierCustomerFixPrice.aspx?method=' + saveType,
                method: 'POST',
                params: {
                    ...
                    UnitId: Ext.getCmp('ProductIdUnit').getValue(),
        ...
        function setFormValue(selectData) {
            Ext.Ajax.request({
                url: 'frmsupplierCustomerFixPrice.aspx?method=getfixpice',
                params: {
                    SpecialPricingId: selectData.data.SpecialPricingId
                },
                success: function(resp, opts) {
                    ...
                    Ext.getCmp('ProductIdUnit').setValue(data.Unit);
                    Ext.getCmp('ProductIdUnitName').setValue(data.UnitText);
                    Ext.getCmp('Specifications').setValue(data.Specifications);
                    Ext.getCmp('SpecificationsText').setValue(data.SpecificationsText);
                    //Ext.getCmp('ValidDate').setValue(Ext.util.Format.date(data.ValidDate, 'Y/m/d'));
                    //Ext.getCmp('ExpireDate').setValue(Ext.util.Format.date(data.ExpireDate, 'Y/m/d'));
                },
                failure: function(resp, opts) {
...
({
    url: 'frmsupplierCustomerFixPrice.aspx?method=getFixpiceList',
    reader: new Ext.data.JsonReader({
        totalProperty: 'totalProperty',
        root: 'root'
    }, [
                ...
                items: [{
                    ...
                    items: [{ cls: 'key',
                        ...
                        handler: function() {
                            ...
                            crmCustomreFixPricegridData.baseParams.PriceType = 98;
