...
public partial class CRM_product_frmCrmCustomerFixPrice : PageBase
{
    ...
    /*
        ...
        */
        string _customerId = this.Request.QueryString["CustomerId"];
        long customerId = 0;
        long.TryParse(_customerId,out customerId);
        script.Append("var customerId = " + customerId.ToString() + ";");
        script.Append("var customerName='" + ZJSIG.UIProcess.CRM.UIBusinessCrmCustomer.getCustomerName(customerId) + "';");
        //script.Append("var customerId");
        script.Append( "</script>\r\n" );
