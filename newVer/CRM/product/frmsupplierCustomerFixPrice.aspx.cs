    ...
    protected void Page_Load( object sender, EventArgs e )
    {
        ...
        switch ( method )
        {
            ...
            case "getSppierProducts":
                if (OrgID == 1)
                    ZJSIG.UIProcess.BA.UIBaProduct.getSuppierProductListForDropDownList(this);
                else
                    ZJSIG.UIProcess.BA.UIBaProduct.getProductListForDropDownList(this);
                break;
            case "getCustomers":
                if (OrgID == 1)
                    ZJSIG.UIProcess.CRM.UIBusinessCrmCustomer.getSuppilerCustomerListForDropDownList(this);
                else
