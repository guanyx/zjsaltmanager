<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFmTaxProjCfg.aspx.cs" Inherits="FM_FmIntf_frmFmTaxProjCfg" %>
...
,       {
		    ...
		    triggerAction:'all',
		    disabled:true,
		    value:dsBillType.getAt(1).data.DicsCode
		}
,       {
			xtype:'combo',
			fieldLabel:'字段分隔符',
    ...
    items: [{
        ...
        items: [{
            ...
            items: [{ cls: 'key',
                ...
                dsProjCfg.baseParams.BillType=dsBillType.getAt(1).data.DicsCode;
                dsProjCfg.load({
                            params : {
                            start : 0,
                            limit : 10
